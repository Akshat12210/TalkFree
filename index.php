...
if (isset($_POST['submit'])) {
    ...
    if ($category === "Counselor") {
      $val = 0;
      $sql2="INSERT INTO counselling.counsellor (Name,UserName,Email,Gender) VALUES('$name','$username','$email','$gender')";
      
    } else {
      $val  = 1;
      $sql2="INSERT INTO counselling.counselle (Name,UserName,Email,Gender) VALUES('$name','$username','$email','$gender')";
