...
include 'connection.php';
 ...
 $sql = "SELECT * FROM users WHERE Email='$email'";
     ...
     $sql1 = "SELECT * from counsellor WHERE Email='$email'";
...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="profilecounsellor.css" />
    <!-- Boxicons CDN Link -->
    <link
  ...
  <body>
    <div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="profile_counsellor.php" class="active">
...
<br>
            ...
            <div class="container">
              <input
                ...
                id="file-input"
                onchange="preview()"
                accept="image/png, image/jpg,application/pdf,application/vnd.ms-excel"
                multiple
              />
              <label for="file-input">
                <i class="fas fa-upload"></i>&nbsp; Choose the Documents
              </label>
              <p id="num-of-files">No Files Chosen</p>
              <div id="images"></div>
            </div>
            <script src="profile-con.js"></script>

            <br />
            <div class="buttons">
            <a href="changePassword.php"><button class="chn-pass" type="button">Change Password</button></a>
            <a href="deleteaccount.php"><button class="delete-acc" type="button">Delete Account</button></a>
            <a href="update.php"><button class="submit"  type="submit">Update</button></a>
</form>
            </div>
          </div>
        </div>
